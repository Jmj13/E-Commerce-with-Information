        	...
        	<div class="row">
				...
				<div class="col-12">
        			<div class="form-group">
		        		...
		        		<textarea class="form-control" rows="12" name="cat_desc" placeholder="Enter category desc"></textarea>
		        	</div>
        		</div>
				...
				<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="cat_link" class="form-control" placeholder="Enter Vedio Link">
		        	</div>
        		</div>
        ...
        <form id="edit-category-form" enctype="multipart/form-data">
          <div class="row">
			...
			<div class="col-12">
        			<div class="form-group">
		        		<label>Category Description</label>
		        		<textarea name="e_cat_desc" class="form-control" rows="12" placeholder="Enter category desc"></textarea>
		        	</div>
        		</div>
				...
				<div class="col-12">
        			<div class="form-group">
		        		<label>Category Link</label>
		        		<input type="text" name="e_cat_link" class="form-control" placeholder="Enter Vedio Link">
		        	</div>
        		</div>
