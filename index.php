	...
	<head>
		...
		<script>
								function showdetails(n){
									document.getElementById('t').innerHTML=n.alt;
									document.getElementById('d').innerHTML=n.id;
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">Information with Ecommerce</a>
			</div>
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				<li><a href="index.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>
				
				<li><a href="index.php"><span class="glyphicon glyphicon-modal-window"></span> Information and Products</a></li>
			</ul>
		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					<div class="panel-heading">Information and Products</div>
					<div class="panel-body">
						<div id="get_product">
